...
abstract class OesTextureRender(private val context: Context) : DestroyableGLRender{
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        val fragmentShaderId = GlesUtil.createFragmentShader(context, R.raw.fragment_oes_shader)
